...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		TranslatorTableName:   strings.TrimSpace(os.Getenv("MYSQL_TRANSLATOR_TABLE")),
	...
	if cfg.TranslatorTableName == "" {
		cfg.TranslatorTableName = defaultTableName
	}

	if err := validateTableName(cfg.TranslatorTableName); err != nil {
		return Config{}, err
	}
	return cfg, nil
