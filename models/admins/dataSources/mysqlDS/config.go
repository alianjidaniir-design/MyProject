...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		AdminTableName:        strings.TrimSpace(os.Getenv("MYSQL_ADMIN_TABLE")),
	...
	if cfg.AdminTableName == "" {
		cfg.AdminTableName = AdminTableName
	}
	if err := ValidateTableName(cfg.AdminTableName); err != nil {
		return cfg, err
	}
	return cfg, nil
}
