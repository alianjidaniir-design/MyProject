...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		SubjectableName:       strings.TrimSpace(os.Getenv("MYSQL_SUBJECT_TABLE")),
	...
	if cfg.SubjectableName == "" {
		cfg.SubjectableName = defaultTableName
	}

	if err := validateTableName(cfg.SubjectableName); err != nil {
		return Config{}, err
	}
	return cfg, nil
