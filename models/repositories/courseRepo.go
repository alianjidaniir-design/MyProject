...
type CourseRepository interface {
	...
	ListDepartment(ctx context.Context, req commonSchema.BaseRequest[courseSchema.DepartmentListRequest]) (res courseSchema.CourseListResponse, errStr string, code int, err error)
}
