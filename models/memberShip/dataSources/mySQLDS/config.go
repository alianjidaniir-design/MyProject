...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		MembershipTableName:   strings.TrimSpace(os.Getenv("MYSQL_MEMBERSHIP_TABLE")),
	...
	if cfg.MembershipTableName == "" {
		cfg.MembershipTableName = defaultTableName
	}

	if err := validateTableName(cfg.MembershipTableName); err != nil {
		return Config{}, err
	}
	return cfg, nil
