...
const (
	defaultTableName      = "rolepermissions"
...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		RolePermissionTableName: strings.TrimSpace(os.Getenv("MYSQL_ROLEPERMISSION_TABLE")),
	...
	if cfg.RolePermissionTableName == "" {
		cfg.RolePermissionTableName = defaultTableName
	}

	if err := validateTableName(cfg.RolePermissionTableName); err != nil {
		return Config{}, err
	}
	return cfg, nil
