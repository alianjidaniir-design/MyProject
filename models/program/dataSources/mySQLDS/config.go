...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		ProgramTableName:      strings.TrimSpace(os.Getenv("MYSQL_PROGRAM_TABLE")),
	...
	if cfg.ProgramTableName == "" {
		cfg.ProgramTableName = defaultTableName
	}

	if err := validateTableName(cfg.ProgramTableName); err != nil {
		return Config{}, err
	}
	return cfg, nil
