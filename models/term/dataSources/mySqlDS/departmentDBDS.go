...
func (ds *DepartmentDBDS) ListDepartment(ctx context.Context, req departmentSchema.ListReq) ([]dataModels.Department, int, error) {
...
func (ds *DepartmentDBDS) DeleteDepartment(ctx context.Context, req departmentSchema.DeleteDepartmentReq) (dataModels.Department, error) {
	var department dataModels.Department
	err := ds.chackDepartment(ctx, req.ID)
	if err != nil {
