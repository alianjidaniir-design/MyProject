...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		PermissionTableName:   strings.TrimSpace(os.Getenv("MYSQL_PERMISSION_TABLE")),
	...
	if cfg.PermissionTableName == "" {
		cfg.PermissionTableName = defaultTableName
	}

	if err := validateTableName(cfg.PermissionTableName); err != nil {
		return Config{}, err
	}
	return cfg, nil
