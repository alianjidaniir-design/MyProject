...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		TeacherTableName:      strings.TrimSpace(os.Getenv("MYSQL_TEACHER_TABLE")),
	...
	if cfg.TeacherTableName == "" {
		cfg.TeacherTableName = TeacherTableName
	}
	if err := ValidateTableName(cfg.TeacherTableName); err != nil {
		return cfg, err
	}
	return cfg, nil
}
