...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		BookTableName:         strings.TrimSpace(os.Getenv("MYSQL_BOOK_TABLE")),
	...
	if cfg.BookTableName == "" {
		cfg.BookTableName = defaultTableName
	}

	if err := validateTableName(cfg.BookTableName); err != nil {
		return Config{}, err
	}
	return cfg, nil
