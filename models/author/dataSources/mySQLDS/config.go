...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		AuthorTableName:       strings.TrimSpace(os.Getenv("MYSQL_AUTHOR_TABLE")),
	...
	if cfg.AuthorTableName == "" {
		cfg.AuthorTableName = defaultTableName
	}

	if err := validateTableName(cfg.AuthorTableName); err != nil {
		return Config{}, err
	}
	return cfg, nil
