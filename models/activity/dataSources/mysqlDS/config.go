...
func LoadConfig() (Config, error) {
	cfg := Config{
		...
		ActivityTableName:     strings.TrimSpace(os.Getenv("MYSQL_ACTIVITY_TABLE")),
	...
	if cfg.ActivityTableName == "" {
		cfg.ActivityTableName = AdminTableName
	}
	if err := ValidateTableName(cfg.ActivityTableName); err != nil {
		return cfg, err
	}
	return cfg, nil
}
